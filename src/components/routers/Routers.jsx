    ...
    <div>
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRoles={['admin', 'super_admin']} />}>
          ...
          <Route path='/admin/projects' element={<Navigate to='/admin/employee-management/projects' replace />} />
          <Route path='/admin/employee-management' element={<Navigate to='/admin/employee-management/projects' replace />} />
          <Route path='/admin/employee-management/projects' element={<ProjectManagement />} />
          <Route path='/admin/employee-management/benches' element={<ProjectManagement />} />
        </Route>
