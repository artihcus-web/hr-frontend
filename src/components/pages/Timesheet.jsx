              ...
              <div className="relative flex flex-col items-center">
                ...
                <div className="text-[10px] font-bold uppercase text-center mt-1">
                  {(() => {
                    ...
                    if (status === 'Draft') return <span className="text-gray-400">Draft</span>;

                    let colorClass = 'text-gray-500';
                    if (status === 'Saved') colorClass = 'text-blue-600';
                    else if (status === 'Submitted') colorClass = 'text-orange-600';
                    else if (status === 'Approved') colorClass = 'text-green-600';
                    else if (status === 'On Hold') colorClass = 'text-yellow-600';
                    else if (status === 'Rejected') colorClass = 'text-red-600';
                    else if (status === 'Changes Requested') colorClass = 'text-orange-600 font-bold';
                    ...
                    return (
                      <div className="flex flex-col items-center">
                        ...
                        {rows.length > 0 && rows[0].rejectionReason && (status === 'Rejected' || status === 'Changes Requested') && (
                          <div className="mt-1 px-2 py-1 bg-red-50 text-red-600 text-[10px] rounded border border-red-100 max-w-[200px] truncate" title={rows[0].rejectionReason}>
