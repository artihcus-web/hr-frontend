            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-2 mb-2 p-1 border-b border-gray-50 dark:border-gray-800 pb-3">
                  ...
                  <h3 className="text-[11px] font-extrabold text-gray-900 dark:text-gray-100 uppercase tracking-widest">Project Narrative</h3>
                </div>
                <div>
                  <label className="block text-[10px] font-extrabold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-2 px-1">Objective & Scope</label>
                  <textarea name="description" value={formData.description} onChange={handleChange} placeholder="Define objectives..." rows={8} className="w-full px-4 py-3 bg-gray-50/50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all text-sm font-medium text-gray-900 dark:text-gray-100 resize-none" />
                </div>
              </div>
            </div>
          </div>
